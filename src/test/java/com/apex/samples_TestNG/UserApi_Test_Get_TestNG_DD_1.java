...
public class UserApi_Test_Get_TestNG_DD_1  extends ApexBaseAPITest implements UserAPIConstants {
	
	@DataProvider(name = "successful_ids")
	public Object[][] getSuccessfulIDs() {
//		Object[][] userInfo = { { "2", "janet.weaver@reqres.in", "janet" },
//				{ "1", "george.bluth@reqres.in", "george" } };

	  return getTableArray("user_ids.xlsx","sheet1","UserSuccessIds");		
	}

	private Object[][] getTableArray(String string, String string2, String string3) {
		// TODO Auto-generated method stub
		return null;
	}

	@Test(dataProvider = "successful_ids")
